...
A public-access SQE practice application with an account-backed mode and a device-local guest mode. The current release contains 2,596 questions: 220 SRA samples, 360 Revise SQE practice-assessment questions, all 654 end-of-chapter SQE1-style questions found across the 14 uploaded Revise SQE 2027 textbooks, and 1,362 retained questions from QLTS Mock Exam source sets 1–20. OUP remains available as an empty library category until imported.
...
The QLTS import is split into five-exam files covering Mocks 1–5, 6–10, 11–15 and 16–20; the matching `-source.json` files record source hashes, page counts and exclusions, while the matching `-translations.json` files provide the Chinese layer. The active bank contains 1,362 questions: 90 / 90 / 86 / 89 / 90 / 75 / 70 / 73 / 72 / 76 / 72 / 80 / 78 / 77 / 72 / 84 / 54 / 0 / 0 / 34. Mock 3 lacks Q25–27 and has no answer capture for Q24; Mock 4 Q75 is obscured by a browser certificate dialog. A total of 298 questions from Mocks 6–20 were removed after current-law review because their keyed answers, explanations or tested frameworks depended on superseded tax figures, the former SRA Handbook or Accounts Rules, old anti-money-laundering rules, pre-Brexit substantive EU law, an obsolete court name, repealed constitutional statutes, the former judicial retirement age or superseded sentencing figures. Mocks 18 and 19 are fully excluded: Mock 18 is a pre-Brexit substantive EU-law module, while Mock 19 is framed throughout by the pre-2019 SRA Handbook. The review records and official sources are in the matching `-removed.json` files. Each retained question keeps its original PDF page numbers.
