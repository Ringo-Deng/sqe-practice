...
{id:'legal-services',zh:'法律服务',en:'Legal Services',group:'FLK1',scope:'法律服务监管、法律服务资金与相关合规要求'},
...
{id:'flk2-ethics',zh:'职业道德（FLK2）',en:'Ethics and Professional Conduct',group:'FLK2',scope:'贯穿 FLK2 情境考查的 SRA 原则、行为准则、保密、冲突与专业义务'}
];
